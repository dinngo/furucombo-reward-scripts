			...
			expected: RewardMerkleProofs{
				...
				Rewards: map[common.Address]RewardMerkleProofsReward{
					common.HexToAddress("0x2f2fcc239a6c5c28f62a4ebe4ffdd180e00663b9"): {
						Amount: decimal.RequireFromString("30026172489673112739215").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x6bc8b3a2773a92c0941eda83611f3063a090c77b"): {
						Amount: decimal.RequireFromString("18274355650261064137294").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x74b746c8d2652cb198a9b0d87bd2315f639caed0"): {
						Amount: decimal.RequireFromString("3515642126116526628746").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x851f9de75c021c90c40e209ffba0488b0320c46f"): {
						Amount: decimal.RequireFromString("26869104389306808913956").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xaa293a146aaf9e05bedd1ff29b0da5bd8be70955"): {
						Amount: decimal.RequireFromString("4128323938714978113081").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xb066c21e2d4ace41bc82a1fdb3d53e385d6fc24b"): {
						Amount: decimal.RequireFromString("26872771430477964988377").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xe02de734d92293ee5725b5e82404aab6d19ad5e9"): {
						Amount: decimal.RequireFromString("12311414367069265458088").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xf849cfcf783f094e66a18da660938013f903817a"): {
						Amount: decimal.RequireFromString("3002215608380279021243").BigInt(),
						Proofs: []common.Hash{
			...
			expected: RewardMerkleProofs{
				...
				Rewards: map[common.Address]RewardMerkleProofsReward{
					common.HexToAddress("0x28c5afd0eee456bf62a8d1187f633ca639b4d9ed"): {
						Amount: decimal.RequireFromString("16488311649245234056167").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x2f2fcc239a6c5c28f62a4ebe4ffdd180e00663b9"): {
						Amount: decimal.RequireFromString("16729101643405008986624").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x6bc8b3a2773a92c0941eda83611f3063a090c77b"): {
						Amount: decimal.RequireFromString("13570679277767782370838").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x74b746c8d2652cb198a9b0d87bd2315f639caed0"): {
						Amount: decimal.RequireFromString("14709682979240536703059").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0x851f9de75c021c90c40e209ffba0488b0320c46f"): {
						Amount: decimal.RequireFromString("28171252009881750777824").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xaa293a146aaf9e05bedd1ff29b0da5bd8be70955"): {
						Amount: decimal.RequireFromString("18045877974535505493763").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xb066c21e2d4ace41bc82a1fdb3d53e385d6fc24b"): {
						Amount: decimal.RequireFromString("13955468885464348203264").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xe02de734d92293ee5725b5e82404aab6d19ad5e9"): {
						Amount: decimal.RequireFromString("3329446834599978209057").BigInt(),
						Proofs: []common.Hash{
					...
					common.HexToAddress("0xf849cfcf783f094e66a18da660938013f903817a"): {
						Amount: decimal.RequireFromString("178745859855199404").BigInt(),
						Proofs: []common.Hash{
			...
			expected: RewardMerkleProofs{
				...
				Rewards: map[common.Address]RewardMerkleProofsReward{
					common.HexToAddress("0x061517CbA46D7c9230C2caa560d1D33680AEE63e"): {
						Amount: decimal.RequireFromString("196078431372549020000").BigInt(),
						Proofs: []common.Hash{
			...
			expected: RewardMerkleProofs{
				...
				Rewards: map[common.Address]RewardMerkleProofsReward{
					common.HexToAddress("0x02b46fb0b491d517e5854fc329522e4f1fb08b13"): {
						Amount: decimal.RequireFromString("20833333333333333333333").BigInt(),
						Proofs: []common.Hash{
